...
function createCard(cardItem) {
  ...
  //add inner card element to the card element
...
function addCardToGridCell(card) {
  const cardPositionClasssName = mapCardIdToGridCell(card)

  const cardPosElem = document.querySelector(cardPositionClasssName)
